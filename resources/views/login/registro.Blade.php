    ...
    <div id="login" class="container-fluid bg_tela justify-content-center d-flex align-items-center">
        ...
        <div id="formulario" class="col-lg-4 p-3 shadow">
            <div class="p-4 text-center">
                ...
                @include('login/erros')
                {{-- SUcesso feed-back here --}}
                {{-- @include('login/sucesso') --}}
            ...
            <form action="cadastrar_usuario" method="post">
                ...
                <div class="row">
                    <div class="form-group col-lg-7">
                        ...
                        <input type="text" name="nome" class="form-control bg_input " id="">
                    </div>
                    <div class="form-group col-lg-5">
                        <label for="data-nasc">Nascimento:</label>
                        <input type="date" name="data_nasc" class="form-control bg_input " id="">
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-lg-7">
                        <label for="email">Email:</label>
                        <input type="email" name="email" class="form-control  bg_input" id="">
                    </div>
                    <div class="form-group col-lg-5">
                        <label for="telefone">Telefone:</label>
                        <input type="tel" name="telefone" class="form-control bg_input " id="">
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-lg-6">
                        <label for="senha">Senha:</label>
                        <input type="password" name="senha" class="form-control bg_input " id="">
                    </div>
                    <div class="form-group col-lg-6">
                        <label for="conf-senha">Conf - Senha:</label>
                        <input type="password" name="conf-senha" class="form-control bg_input " id="">
                    </div>
                </div>
